...
export default class DeviceStore {
  constructor() {
    ...
    this._devices = [
      ...
      {id: 5, name: 'Iphone 12 pro', price: 25000, rating: 5, img: 'https://via.placeholder.com/200x100'},
      {id: 6, name: 'Iphone 12 pro', price: 25000, rating: 5, img: 'https://via.placeholder.com/200x100'},
    ]
    this._selectedType = {}
    this._selectedBrand = {}
